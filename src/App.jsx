...
// ============================================================
const ALL_QUESTIONS = [
  { id:1, question:"Hur långt sträcker sig Sverige från norr till söder?", options:["Cirka 800 km","Cirka 1 200 km","Cirka 1 600 km","Cirka 2 000 km"], correctAnswer:2, chapter:1, chapterName:"Landet Sverige", difficulty:"easy", tags:["geografi"], explanation:"Sverige sträcker sig cirka 1 600 kilometer från den nordligaste punkten Treriksröset till den sydligaste punkten Smygehuk." },
  { id:2, question:"Vad heter havet vid Sveriges östra kust?", options:["Nordsjön","Östersjön","Kattegatt","Skagerrak"], correctAnswer:1, chapter:1, chapterName:"Landet Sverige", difficulty:"easy", tags:["geografi"], explanation:"Havet vid den östra kusten heter Östersjön. Haven vid den västra kusten heter Skagerrak och Kattegatt." },
  { id:3, question:"Vad heter Sveriges högsta berg?", options:["Åre","Sylarna","Kebnekaise","Sarek"], correctAnswer:2, chapter:1, chapterName:"Landet Sverige", difficulty:"medium", tags:["geografi","natur"], explanation:"Sveriges högsta berg är Kebnekaise som är cirka 2 000 meter högt och ligger i bergskedjan Skanderna längs gränsen mot Norge." },
  { id:4, question:"Vilka är de tre största sjöarna i Sverige?", options:["Siljan, Storsjön och Hjälmaren","Vänern, Vättern och Mälaren","Vänern, Mälaren och Hjälmaren","Vättern, Siljan och Storsjön"], correctAnswer:1, chapter:1, chapterName:"Landet Sverige", difficulty:"easy", tags:["geografi","natur"], explanation:"De tre största sjöarna i Sverige är Vänern, Vättern och Mälaren." },
  { id:5, question:"I hur många landsdelar brukar Sverige delas in?", options:["Två","Tre","Fyra","Fem"], correctAnswer:1, chapter:1, chapterName:"Landet Sverige", difficulty:"easy", tags:["geografi","indelning"], explanation:"Sverige brukar delas in i tre stora landsdelar: Götaland i söder, Svealand i mitten och Norrland i norr." },
  { id:6, question:"Hur många kommuner är Sverige indelat i?", options:["21","110","290","349"], correctAnswer:2, chapter:1, chapterName:"Landet Sverige", difficulty:"medium", tags:["indelning"], explanation:"Sverige är indelat i 290 kommuner samt 21 län." },
  { id:7, question:"Ungefär hur stor andel av Sveriges befolkning bor i städer?", options:["55 procent","70 procent","85 procent","95 procent"], correctAnswer:2, chapter:1, chapterName:"Landet Sverige", difficulty:"medium", tags:["befolkning"], explanation:"Ungefär 85 procent av Sveriges befolkning bor i städer. De tre största städerna är Stockholm, Göteborg och Malmö." },
  { id:8, question:"Vad är det främsta målet för Sveriges klimatlag?", options:["Förbjuda bensinbilar till 2030","Utsläppen ska vara nära noll år 2045","Halvera utsläppen till 2035","Öka andelen solenergi till 50 procent"], correctAnswer:1, chapter:1, chapterName:"Landet Sverige", difficulty:"medium", tags:["klimat","miljö"], explanation:"Ett mål i Sveriges klimatlag är att utsläppen av växthusgaser ska vara så nära noll som möjligt år 2045." },
  { id:9, question:"Vad betyder ordet demokrati?", options:["Frihet för alla","Folkstyre","Rättvisans lag","Majoritetsbeslut"], correctAnswer:1, chapter:2, chapterName:"Sveriges demokratiska system", difficulty:"easy", tags:["demokrati"], explanation:"Ordet demokrati kommer från grekiskan och betyder folkstyre. Det är ett politiskt system där makten utgår från folket." },
  { id:10, question:"Vad innebär rättssäkerhet?", options:["Att polisen alltid har rätt","Att alla behandlas lika inför lagen och får en rättvis rättegång","Att brott alltid bestraffas hårt","Att domstolar styrs av regeringen"], correctAnswer:1, chapter:2, chapterName:"Sveriges demokratiska system", difficulty:"medium", tags:["demokrati","rättsväsende"], explanation:"Rättssäkerhet innebär att alla behandlas lika inför lagen och har rätt till en rättvis rättegång." },
  { id:11, question:"Vad kan ett lågt valdeltagande leda till?", options:["Starkare demokrati","Att fler partier bildas","Att människor får mindre möjligheter att påverka beslut","Billigare val"], correctAnswer:2, chapter:2, chapterName:"Sveriges demokratiska system", difficulty:"medium", tags:["demokrati","val"], explanation:"Ett lågt valdeltagande kan leda till att människor får mindre möjligheter att påverka politiska beslut i sin vardag." },
  { id:12, question:"Vad innebär segregation?", options:["Att alla bor i samma område","Att människor lever åtskilda beroende på ekonomi eller etnisk bakgrund","Att invandrare välkomnas i samhället","Att skolor blandas med olika åldrar"], correctAnswer:1, chapter:2, chapterName:"Sveriges demokratiska system", difficulty:"medium", tags:["demokrati","integration"], explanation:"Segregation innebär att människor lever åtskilda beroende på hur mycket pengar de tjänar eller vilken etnisk bakgrund de har." },
  { id:13, question:"Vilket av följande är INTE ett sätt att delta i demokratin?", options:["Rösta i val","Kontakta politiker","Ignorera nyheter och samhällsfrågor","Skriva debattartiklar"], correctAnswer:2, chapter:2, chapterName:"Sveriges demokratiska system", difficulty:"easy", tags:["demokrati","delaktighet"], explanation:"Att ignorera nyheter och samhällsfrågor är inte ett sätt att delta i demokratin. Demokratin stärks när medborgarna engagerar sig och röstar." },
  { id:14, question:"Vad innebär yttrandefrihet?", options:["Rätten att bära vapen","Rätten att skriva och säga vad man tycker","Rätten att inte betala skatt","Rätten att vägra militärtjänst"], correctAnswer:1, chapter:2, chapterName:"Sveriges demokratiska system", difficulty:"easy", tags:["demokrati","rättigheter"], explanation:"Yttrandefrihet innebär rätten att skriva och säga vad man tycker. Det är en grundläggande förutsättning för demokrati." },
  { id:15, question:"Vad är integration?", options:["Att utländska medborgare lämnar landet","Att människor med olika bakgrund lever närmare varandra och känner sig delaktiga i samhället","Att alla talar samma språk","Att invandrare anpassar sig fullständigt till majoritetssamhället"], correctAnswer:1, chapter:2, chapterName:"Sveriges demokratiska system", difficulty:"medium", tags:["demokrati","integration"], explanation:"Integration betyder att människor med olika bakgrund och ekonomi lever närmare varandra och känner sig delaktiga i samhället." },
  { id:16, question:"Vad är ett hot mot demokratin?", options:["Högt valdeltagande","Spridning av falsk information och hat på sociala medier","Många politiska partier","Fria medier"], correctAnswer:1, chapter:2, chapterName:"Sveriges demokratiska system", difficulty:"easy", tags:["demokrati","hot"], explanation:"Spridning av falsk information och hat på sociala medier är ett hot mot demokratin." },
  { id:17, question:"Hur många ledamöter har riksdagen?", options:["249","299","349","399"], correctAnswer:2, chapter:3, chapterName:"Så här styrs Sverige", difficulty:"easy", tags:["riksdag","politik"], explanation:"Riksdagen har 349 ledamöter som väljs vart fjärde år." },
  { id:18, question:"Hur ofta väljs riksdagens ledamöter?", options:["Vart tredje år","Vart fjärde år","Vart femte år","Vart sjätte år"], correctAnswer:1, chapter:3, chapterName:"Så här styrs Sverige", difficulty:"easy", tags:["riksdag","val"], explanation:"Riksdagens 349 ledamöter väljs vart fjärde år i allmänna val." },
  { id:19, question:"Vad kallas de partier som inte stödjer regeringen?", options:["Minoriteten","Oppositionen","Koalitionen","Reserven"], correctAnswer:1, chapter:3, chapterName:"Så här styrs Sverige", difficulty:"easy", tags:["riksdag","politik"], explanation:"De partier som inte stödjer regeringen kallas för opposition. Deras uppgift är att granska regeringens arbete." },
  { id:20, question:"Vad är regionernas främsta uppgift?", options:["Att bygga vägar","Att ansvara för hälso- och sjukvården","Att driva skolor","Att ta ut tullar"], correctAnswer:1, chapter:3, chapterName:"Så här styrs Sverige", difficulty:"easy", tags:["regioner","sjukvård"], explanation:"Regionernas främsta uppgift är att ansvara för hälso- och sjukvården." },
  { id:21, question:"Hur många regioner finns det i Sverige?", options:["13","17","21","25"], correctAnswer:2, chapter:3, chapterName:"Så här styrs Sverige", difficulty:"medium", tags:["regioner","indelning"], explanation:"Sverige är indelat i 21 regioner som styrs av folkvalda politiker." },
  { id:22, question:"Vad heter de myndigheter som kontrollerar att andra myndigheter gör rätt?", options:["Riksrevisionen och Datainspektionen","Justitieombudsmannen (JO) och Justitiekanslern (JK)","Riksbanken och Finansinspektionen","Polisen och Åklagarmyndigheten"], correctAnswer:1, chapter:3, chapterName:"Så här styrs Sverige", difficulty:"hard", tags:["myndigheter","kontroll"], explanation:"Justitieombudsmannen (JO) och Justitiekanslern (JK) kontrollerar att andra myndigheter gör rätt." },
  { id:23, question:"Vad är en budgetproposition?", options:["En lag om skatter","Regeringens förslag till riksdagen om statens inkomster och utgifter","En plan för kommunernas ekonomi","EU:s krav på Sverige"], correctAnswer:1, chapter:3, chapterName:"Så här styrs Sverige", difficulty:"medium", tags:["riksdag","ekonomi"], explanation:"Varje höst lämnar regeringen budgetpropositionen – ett förslag till riksdagen om statens inkomster och utgifter." },
  { id:24, question:"Vad ansvarar kommunerna för?", options:["Sjukvård och kollektivtrafik","Försvar och polis","Skola, äldreomsorg och vatten/avlopp","Riksdag och lagstiftning"], correctAnswer:2, chapter:3, chapterName:"Så här styrs Sverige", difficulty:"easy", tags:["kommuner","välfärd"], explanation:"Kommunerna ansvarar för skola, äldreomsorg, vatten/avlopp, snöröjning och annan lokal service." },
  { id:25, question:"Hur gammal måste man vara för att få rösta i Sverige?", options:["16 år","17 år","18 år","20 år"], correctAnswer:2, chapter:4, chapterName:"Politiska val och partier", difficulty:"easy", tags:["val","rösträtt"], explanation:"För att ha rätt att rösta ska man ha fyllt 18 år." },
  { id:26, question:"Vad krävs för att rösta i riksdagsvalet?", options:["Att man bott i Sverige i minst ett år","Att man är svensk medborgare","Att man är EU-medborgare","Att man är folkbokförd i Sverige"], correctAnswer:1, chapter:4, chapterName:"Politiska val och partier", difficulty:"medium", tags:["val","rösträtt"], explanation:"För att rösta i riksdagsvalet måste man vara svensk medborgare och ha fyllt 18 år." },
  { id:27, question:"Hur ofta hålls val till EU-parlamentet?", options:["Vart tredje år","Vart fjärde år","Vart femte år","Vart sjätte år"], correctAnswer:2, chapter:4, chapterName:"Politiska val och partier", difficulty:"medium", tags:["val","EU"], explanation:"Val till riksdag, regioner och kommuner hålls vart fjärde år. Val till EU-parlamentet hålls vart femte år." },
  { id:28, question:"Vad innebär proportionella val?", options:["Det parti som får flest röster tar alla platser","Partierna får platser i proportion till andelen röster de fått","Varje region får lika många platser","Statsministern utser vinnaren"], correctAnswer:1, chapter:4, chapterName:"Politiska val och partier", difficulty:"medium", tags:["val","valsystem"], explanation:"Proportionella val innebär att partierna får platser i riksdagen utifrån den andel röster de fått." },
  { id:29, question:"Hur stor andel av rösterna måste ett parti få för att komma in i riksdagen?", options:["Två procent","Tre procent","Fyra procent","Fem procent"], correctAnswer:2, chapter:4, chapterName:"Politiska val och partier", difficulty:"medium", tags:["val","riksdag"], explanation:"För att komma in i riksdagen måste ett parti få minst fyra procent av rösterna." },
  { id:30, question:"Vilket av dessa partier sitter i riksdagen (fram till valet 2026)?", options:["Feministiskt initiativ","Piratpartiet","Miljöpartiet","Junilistan"], correctAnswer:2, chapter:4, chapterName:"Politiska val och partier", difficulty:"medium", tags:["partier","riksdag"], explanation:"Miljöpartiet (MP) är ett av de åtta riksdagspartierna. De övriga är C, KD, L, M, S, SD och V." },
  { id:31, question:"Vad är en folkomröstning?", options:["Ett val till riksdagen","En omröstning om en särskild fråga som kan hållas nationellt, regionalt eller lokalt","En undersökning gjord av ett opinionsföretag","En omröstning bland riksdagsledamöterna"], correctAnswer:1, chapter:4, chapterName:"Politiska val och partier", difficulty:"easy", tags:["val","demokrati"], explanation:"Folkomröstningar hålls om en särskild fråga och är rådgivande – politikerna måste inte följa resultatet." },
  { id:32, question:"Vad röstade Sverige nej till i folkomröstningen 2003?", options:["Medlemskap i EU","Att byta till valutan euro","NATO-medlemskap","En ny grundlag"], correctAnswer:1, chapter:4, chapterName:"Politiska val och partier", difficulty:"hard", tags:["val","historia","EU"], explanation:"År 2003 röstade Sverige nej till att byta ut den svenska kronan mot euro." },
  { id:33, question:"Hur många grundlagar har Sverige?", options:["Två","Tre","Fyra","Fem"], correctAnswer:2, chapter:5, chapterName:"Lag och rätt", difficulty:"medium", tags:["grundlagar","lag"], explanation:"Sverige har fyra grundlagar: regeringsformen, tryckfrihetsförordningen, yttrandefrihetsgrundlagen och successionsordningen." },
  { id:34, question:"Vad skyddar tryckfrihetsförordningen?", options:["Rätten att demonstrera","Det fria ordet i tryckt form – böcker, tidningar och tidskrifter","Rätten att använda internet","Radio och tv"], correctAnswer:1, chapter:5, chapterName:"Lag och rätt", difficulty:"medium", tags:["grundlagar","yttrandefrihet"], explanation:"Tryckfrihetsförordningen skyddar det fria ordet i tryckt form och ger alla rätt att ge ut böcker och tidningar." },
  { id:35, question:"Vad innebär allemansrätten?", options:["Alla har rätt till gratis utbildning","Alla har rätt att vistas i naturen oavsett vem som äger marken","Alla har rätt till bostad","Alla har rätt till sjukvård"], correctAnswer:1, chapter:5, chapterName:"Lag och rätt", difficulty:"easy", tags:["grundlagar","natur"], explanation:"Allemansrätten ger alla möjlighet att vara i naturen oavsett vem som äger marken. Den är skyddad i regeringsformen." },
  { id:36, question:"Vilken domstol är första instans i Sverige?", options:["Högsta domstolen","Hovrätten","Tingsrätten","Förvaltningsrätten"], correctAnswer:2, chapter:5, chapterName:"Lag och rätt", difficulty:"medium", tags:["domstolar","rättsväsende"], explanation:"Tingsrätten är första instans där brottsmål och tvistemål börjar. Sedan kan man överklaga till hovrätten." },
  { id:37, question:"Från vilken ålder kan en person bli åtalad för brott i Sverige?", options:["12 år","13 år","15 år","18 år"], correctAnswer:2, chapter:5, chapterName:"Lag och rätt", difficulty:"medium", tags:["lag","brott"], explanation:"I Sverige är en person straffmyndig och kan bli åtalad för brott från 15 års ålder." },
  { id:38, question:"Vad är Åklagarmyndighetens uppgift?", options:["Att utreda brott","Att avgöra om misstänkta ska ställas inför domstol","Att döma brottslingar","Att verkställa straff"], correctAnswer:1, chapter:5, chapterName:"Lag och rätt", difficulty:"medium", tags:["rättsväsende","lag"], explanation:"Åklagarmyndigheten avgör om personer som misstänks för brott ska ställas inför domstol." },
  { id:39, question:"Vad menas med att domstolarna är oberoende?", options:["Att de finansieras av privata företag","Att regering och riksdag inte kan bestämma hur de ska döma","Att de inte behöver följa lagen","Att deras beslut aldrig kan överklagas"], correctAnswer:1, chapter:5, chapterName:"Lag och rätt", difficulty:"medium", tags:["domstolar","rättsäkerhet"], explanation:"Domstolarnas oberoende innebär att regering eller riksdag inte kan bestämma hur de ska döma." },
  { id:40, question:"Vad bestämmer successionsordningen?", options:["Hur val ska genomföras","Vem som ska bli kung eller drottning efter den nuvarande","Hur lagar stiftas","Medborgarnas grundläggande rättigheter"], correctAnswer:1, chapter:5, chapterName:"Lag och rätt", difficulty:"hard", tags:["grundlagar","monarki"], explanation:"Successionsordningen är den grundlag som bestämmer vem som ska bli kung eller drottning efter den nuvarande." },
  { id:41, question:"Vad innebär offentlighetsprincipen?", options:["Att alla politiska möten är öppna","Att allmänna handlingar från myndigheter är offentliga och kan begäras ut","Att journalister har rätt att delta i domstolsförhandlingar","Att staten måste finansiera alla medier"], correctAnswer:1, chapter:6, chapterName:"Mediernas roll", difficulty:"medium", tags:["medier","demokrati"], explanation:"Offentlighetsprincipen innebär att allmänna handlingar från myndigheter är offentliga och kan begäras ut av vem som helst." },
  { id:42, question:"Vilka tre företag räknas som public service i Sverige?", options:["SVT, TV4 och SR","SR, SVT och UR","SVT, UR och Aftonbladet","SR, SVT och TT"], correctAnswer:1, chapter:6, chapterName:"Mediernas roll", difficulty:"medium", tags:["medier","public service"], explanation:"De tre public service-företagen är Sveriges Radio (SR), Sveriges Television (SVT) och Utbildningsradion (UR)." },
  { id:43, question:"Hur finansieras public service i Sverige?", options:["Genom reklamintäkter","Genom frivilliga donationer","Genom en avgift som tas ut via skatten","Genom EU-bidrag"], correctAnswer:2, chapter:6, chapterName:"Mediernas roll", difficulty:"medium", tags:["medier","public service"], explanation:"Public service finansieras genom en avgift via skatten – inte genom reklam – så att alla ska ha tillgång till saklig information." },
  { id:44, question:"Vad innebär källkritik?", options:["Att man alltid litar på experter","Att ifrågasätta och kontrollera om information man läser eller hör är korrekt","Att bara läsa statliga medier","Att undvika sociala medier"], correctAnswer:1, chapter:6, chapterName:"Mediernas roll", difficulty:"easy", tags:["medier","källkritik"], explanation:"Källkritik innebär att ifrågasätta och kontrollera om det man läser, ser eller hör är korrekt." },
  { id:45, question:"Vad gäller för en person som lämnar uppgifter till tidningar eller radio?", options:["De kan straffas om informationen är känslig","De har rätt att vara anonyma och kan inte straffas","De måste alltid uppge sitt namn","De behöver tillstånd från myndigheter"], correctAnswer:1, chapter:6, chapterName:"Mediernas roll", difficulty:"hard", tags:["medier","yttrandefrihet"], explanation:"En person har rätt att lämna uppgifter till media utan att straffas och har också rätt att vara anonym." },
  { id:46, question:"Varför är det viktigt med många olika medier?", options:["För att sänka priset på tidningar","För att ge medborgarna tillgång till olika perspektiv och nyheter","För att statens kontroll ska bli enklare","För att journalister ska ha fler jobbalternativ"], correctAnswer:1, chapter:6, chapterName:"Mediernas roll", difficulty:"easy", tags:["medier","demokrati"], explanation:"Många olika medier ger medborgarna tillgång till olika perspektiv. Staten ger därför ekonomiskt stöd till nyhetsmedier." },
  { id:47, question:"Vad är en ansvarig utgivare?", options:["Chefen för Pressombudsmannen","En person som är juridiskt ansvarig för vad som publiceras i en tidning, radio eller tv","En statlig kontrollant av medier","En journalist med lång erfarenhet"], correctAnswer:1, chapter:6, chapterName:"Mediernas roll", difficulty:"hard", tags:["medier","lag"], explanation:"Tidningar, radio och tv har en ansvarig utgivare som är juridiskt ansvarig för det som publiceras." },
  { id:48, question:"När presenterade FN sin förklaring om de mänskliga rättigheterna?", options:["1945","1948","1951","1960"], correctAnswer:1, chapter:7, chapterName:"Mänskliga rättigheter", difficulty:"medium", tags:["mänskliga rättigheter","FN"], explanation:"FN presenterade förklaringen om de mänskliga rättigheterna 1948. Den innehåller 30 artiklar." },
  { id:49, question:"Vad innebär Sveriges samtyckeslag?", options:["Att man måste ha tillstånd för att gifta sig","Att den som vill ha sex måste försäkra sig om att den andra personen deltar frivilligt","Att föräldrar måste godkänna sina barns relationer","Att sexköp är lagligt om båda parter är överens"], correctAnswer:1, chapter:7, chapterName:"Mänskliga rättigheter", difficulty:"medium", tags:["jämställdhet","lag"], explanation:"Samtyckeslagen innebär att den som vill ha sex måste försäkra sig om att den andra deltar frivilligt – även inom äktenskapet." },
  { id:50, question:"Vilket år blev barnkonventionen lag i Sverige?", options:["2000","2010","2015","2020"], correctAnswer:3, chapter:7, chapterName:"Mänskliga rättigheter", difficulty:"medium", tags:["barn","lag"], explanation:"FN:s barnkonvention blev lag i Sverige år 2020." },
  { id:51, question:"Vilka fem grupper erkändes år 2000 som nationella minoriteter i Sverige?", options:["Somalier, iranier, kurder, polacker och romer","Judar, romer, samer, sverigefinnar och tornedalingar","Samer, finnar, norrmän, danskar och tyskar","Romer, samer, kurder, assyrier och judar"], correctAnswer:1, chapter:7, chapterName:"Mänskliga rättigheter", difficulty:"hard", tags:["minoriteter","rättigheter"], explanation:"År 2000 erkände Sverige judar, romer, samer, sverigefinnar och tornedalingar som nationella minoriteter." },
  { id:52, question:"Vad gör Diskrimineringsombudsmannen (DO)?", options:["Skyddar yttrande- och pressfrihet","Arbetar för allas lika rättigheter och ser till att diskrimineringslagen följs","Hanterar klagomål mot polisen","Övervakar politiska partier"], correctAnswer:1, chapter:7, chapterName:"Mänskliga rättigheter", difficulty:"medium", tags:["diskriminering","myndigheter"], explanation:"DO är en statlig myndighet som arbetar för allas lika rättigheter och möjligheter och ser till att diskrimineringslagen följs." },
  { id:53, question:"Vilket år blev det lagligt att vara homosexuell i Sverige?", options:["1944","1964","1979","1995"], correctAnswer:0, chapter:7, chapterName:"Mänskliga rättigheter", difficulty:"hard", tags:["hbtqi","historia"], explanation:"1944 blev det lagligt att vara homosexuell i Sverige. År 2003 fick homosexuella par rätt att adoptera barn." },
  { id:54, question:"Vad är ett hatbrott?", options:["Ett brott begånget i affekt","Ett brott mot en person för att de tillhör en viss grupp","Näthat och trakasserier online","Brott som begås av organiserade grupper"], correctAnswer:1, chapter:7, chapterName:"Mänskliga rättigheter", difficulty:"medium", tags:["diskriminering","brott"], explanation:"Hatbrott är brott mot en person för att de tillhör en viss grupp. Gärningspersonen får ett strängare straff vid hatbrottsmotiv." },
  { id:55, question:"Vad är hedersrelaterat våld?", options:["Våld i samband med sportevenemang","När en familj eller grupp försöker kontrollera familjemedlemmars beteende med våld eller hot","Psykiska besvär orsakade av krig","Brott begångna för att hämnas en förolämpning"], correctAnswer:1, chapter:7, chapterName:"Mänskliga rättigheter", difficulty:"medium", tags:["jämställdhet","våld"], explanation:"Hedersrelaterat våld innebär att en familj eller grupp försöker kontrollera hur familjemedlemmar beter sig med våld eller hot." },
  { id:56, question:"Hur stor andel av Sveriges arbetskraft arbetar inom privat sektor?", options:["Cirka 30 procent","Cirka 50 procent","Cirka 70 procent","Cirka 90 procent"], correctAnswer:2, chapter:8, chapterName:"Arbetsmarknad och privatekonomi", difficulty:"medium", tags:["arbetsmarknad","ekonomi"], explanation:"Omkring 70 procent av alla som jobbar i Sverige arbetar inom den privata sektorn. Cirka 30 procent jobbar inom offentlig sektor." },
  { id:57, question:"Vad är ett kollektivavtal?", options:["En lag stiftad av riksdagen om löner","Ett avtal om löner och arbetsvillkor som tecknas mellan fackförbund och arbetsgivare","En EU-förordning om arbetstider","Ett avtal mellan stat och kommuner"], correctAnswer:1, chapter:8, chapterName:"Arbetsmarknad och privatekonomi", difficulty:"medium", tags:["arbetsmarknad","fackföreningar"], explanation:"Kollektivavtal är avtal om löner och arbetsvillkor som tecknas mellan fackförbund och arbetsgivarorganisationer." },
  { id:58, question:"Vad är A-kassans syfte?", options:["Att finansiera pensioner","Att ge ekonomiskt stöd till arbetslösa medlemmar","Att betala ut barnbidrag","Att finansiera sjukhusvård"], correctAnswer:1, chapter:8, chapterName:"Arbetsmarknad och privatekonomi", difficulty:"easy", tags:["arbetsmarknad","försäkringar"], explanation:"A-kassan betalar ut pengar till arbetslösa medlemmar som aktivt söker arbete." },
  { id:59, question:"Vad är LO?", options:["En statlig arbetsmarknadsmyndighet","Landsorganisationen i Sverige – en av de största fackliga centralorganisationerna","En arbetsgivarorganisation för industrin","En myndighet som godkänner kollektivavtal"], correctAnswer:1, chapter:8, chapterName:"Arbetsmarknad och privatekonomi", difficulty:"medium", tags:["arbetsmarknad","fackföreningar"], explanation:"LO (Landsorganisationen i Sverige) är en av de tre stora fackliga centralorganisationerna – de andra är TCO och SACO." },
  { id:60, question:"Vad gör Kronofogdemyndigheten?", options:["Kontrollerar skattedeklarationer","Ser till att skulder betalas och hjälper vid skuldsanering","Beslutar om bankräntor","Godkänner lån från banker"], correctAnswer:1, chapter:8, chapterName:"Arbetsmarknad och privatekonomi", difficulty:"medium", tags:["privatekonomi","myndigheter"], explanation:"Kronofogdemyndigheten ser till att skulder blir betalda och kan hjälpa personer med stora skulder via skuldsanering." },
  { id:61, question:"Vad innebär att arbeta svart?", options:["Att arbeta nattskift","Att arbeta utan att betala skatt, vilket är olagligt","Att arbeta utan kollektivavtal","Att arbeta övertid utan betalning"], correctAnswer:1, chapter:8, chapterName:"Arbetsmarknad och privatekonomi", difficulty:"easy", tags:["arbetsmarknad","skatt"], explanation:"Det är olagligt att arbeta utan att betala skatt – det kallas att arbeta svart." },
  { id:62, question:"Vad representerar Svenskt näringsliv?", options:["Offentliga arbetsgivare","Privata företag på arbetsmarknaden","Fackföreningarnas intressen","Statens intressen i löneförhandlingar"], correctAnswer:1, chapter:8, chapterName:"Arbetsmarknad och privatekonomi", difficulty:"hard", tags:["arbetsmarknad","organisationer"], explanation:"Svenskt näringsliv är den största arbetsgivarorganisationen och representerar privata företag." },
  { id:63, question:"Vad är moms?", options:["En skatt på inkomst","En skatt (mervärdesskatt) på varor och tjänster","En avgift för sjukvård","En kommunal fastighetsskatt"], correctAnswer:1, chapter:9, chapterName:"Välfärdssamhället", difficulty:"easy", tags:["skatter","ekonomi"], explanation:"Moms (mervärdesskatt) är en skatt man betalar när man köper varor och tjänster." },
  { id:64, question:"Vad finansierar staten inom välfärden?", options:["Skola och äldreomsorg","Pensioner, sjukförsäkring, föräldraförsäkring och barnbidrag","Sjukhus och vårdcentraler","Vatten och avlopp"], correctAnswer:1, chapter:9, chapterName:"Välfärdssamhället", difficulty:"medium", tags:["välfärd","försäkringar"], explanation:"Staten finansierar pensioner, sjukförsäkring, föräldraförsäkring, arbetslöshetsförsäkring, studiestöd och barnbidrag." },
  { id:65, question:"Vilket är kommunernas ansvar inom välfärden?", options:["Sjukvård och högre utbildning","Barnomsorg, grundskola och äldreomsorg","Pensioner och sjukförsäkring","Kollektivtrafik och länsmuseer"], correctAnswer:1, chapter:9, chapterName:"Välfärdssamhället", difficulty:"medium", tags:["kommuner","välfärd"], explanation:"Kommunerna ansvarar för barnomsorg, skola och äldreomsorg." },
  { id:66, question:"Vad är primärvård?", options:["Akutsjukhus och universitetssjukhus","Vårdcentraler och barnavårds- och mödravårdscentraler","Psykiatrisk vård och rehabilitering","Specialistmottagningar på sjukhus"], correctAnswer:1, chapter:9, chapterName:"Välfärdssamhället", difficulty:"medium", tags:["sjukvård","välfärd"], explanation:"Primärvård inkluderar vårdcentraler och barnavårds- och mödravårdscentraler – den närmaste vården för invånarna." },
  { id:67, question:"Vad är socialtjänstens uppgift i kommunen?", options:["Att bedriva sjukvård","Att ge stöd och skydd till de som behöver det","Att bygga bostäder","Att driva skolor"], correctAnswer:1, chapter:9, chapterName:"Välfärdssamhället", difficulty:"easy", tags:["kommuner","socialtjänst"], explanation:"Socialtjänsten ansvarar för att de som behöver får stöd och skydd – t.ex. familjer utan pengar eller utsatta för våld." },
  { id:68, question:"Vem betalar arbetsgivaravgifter?", options:["Den anställde drar av dem från lönen","Arbetsgivaren betalar dem till staten utöver de anställdas löner","Staten betalar dem direkt till pensionsfonden","Fackförbunden administrerar dem"], correctAnswer:1, chapter:9, chapterName:"Välfärdssamhället", difficulty:"medium", tags:["skatter","arbetsmarknad"], explanation:"Arbetsgivare betalar avgifter till staten utöver lönen. Pengarna går bland annat till sjukförsäkring och pensioner." },
  { id:69, question:"Vem ansvarar för kollektivtrafiken i Sverige?", options:["Staten","Kommunerna","Regionerna","Privata trafikbolag utan statligt uppdrag"], correctAnswer:2, chapter:9, chapterName:"Välfärdssamhället", difficulty:"medium", tags:["regioner","välfärd"], explanation:"Regionerna ansvarar för kollektivtrafiken – bussar, spårvagnar och tunnelbanor – inom sin region." },
  { id:70, question:"Vilket år fick både män och kvinnor rösta i riksdagsvalet för första gången?", options:["1909","1918","1921","1931"], correctAnswer:2, chapter:10, chapterName:"Sveriges moderna historia", difficulty:"medium", tags:["historia","demokrati","rösträtt"], explanation:"1921 genomfördes det första riksdagsvalet där både män och kvinnor fick rösta och ställa upp som kandidater." },
  { id:71, question:"Vad var Saltsjöbadsavtalet?", options:["En fredsöverenskommelse efter andra världskriget","Ett avtal 1938 mellan arbetsgivare och fackförbund som lade grunden för den svenska modellen","En ny grundlag om arbetsrätt","Ett handelsavtal med Norge"], correctAnswer:1, chapter:10, chapterName:"Sveriges moderna historia", difficulty:"hard", tags:["historia","arbetsmarknad"], explanation:"Saltsjöbadsavtalet 1938 lade grunden för den svenska modellen där parterna – inte politikerna – bestämmer arbetsmarknadens villkor." },
  { id:72, question:"Vad var miljonprogrammet?", options:["Ett ekonomiskt stödprogram under kriget","En satsning under 1960-talet för att bygga en miljon bostäder på tio år","En utbildningssatsning för att få fler akademiker","Ett program för att locka invandrare till Sverige"], correctAnswer:1, chapter:10, chapterName:"Sveriges moderna historia", difficulty:"medium", tags:["historia","bostäder"], explanation:"Under 1960-talet startade miljonprogrammet för att lösa bostadsbristen – målet var en miljon bostäder på tio år." },
  { id:73, question:"Under vilka krig höll sig Sverige neutralt och stod utanför striderna?", options:["Krimkriget och Napoleonkrigen","Första och andra världskriget","Finska vinterkriget och Koreakriget","Vietnamkriget och Gulfkriget"], correctAnswer:1, chapter:10, chapterName:"Sveriges moderna historia", difficulty:"easy", tags:["historia","krig"], explanation:"Sverige förklarade sig neutralt under både första (1914–1918) och andra världskriget (1939–1945)." },
  { id:74, question:"Vad var idén om folkhemmet?", options:["Att alla skulle ha rätt till ett eget hem","En idé formulerad 1928 om ett samhälle där alla skulle kunna känna trygghet och gemenskap","Ett bostadsprogram för fattiga","En nationalistisk rörelse på 1930-talet"], correctAnswer:1, chapter:10, chapterName:"Sveriges moderna historia", difficulty:"medium", tags:["historia","politik"], explanation:"1928 formulerade Per Albin Hansson (S) idén om folkhemmet – ett samhälle med trygghet och gemenskap för alla." },
  { id:75, question:"Vem var Raoul Wallenberg?", options:["En svensk statsminister under andra världskriget","En svensk diplomat som räddade judars liv under förintelsen genom skyddspass","Chefen för svenska Röda Korset under kriget","En general i svenska armén"], correctAnswer:1, chapter:10, chapterName:"Sveriges moderna historia", difficulty:"medium", tags:["historia","andra världskriget"], explanation:"Raoul Wallenberg var en svensk diplomat som under förintelsen gav judar skyddspass så att de inte kunde skickas till koncentrationsläger." },
  { id:76, question:"Vad kallas perioden efter andra världskriget med stark ekonomisk tillväxt?", options:["Industriåldern","Folkhemsepoken","Rekordåren","Välfärdsdekaderna"], correctAnswer:2, chapter:10, chapterName:"Sveriges moderna historia", difficulty:"medium", tags:["historia","ekonomi"], explanation:"Perioden efter andra världskriget med stark ekonomisk tillväxt och låg arbetslöshet kallas de svenska rekordåren." },
  { id:77, question:"Ungefär hur många svenskar utvandrade till USA mellan 1850 och 1920?", options:["Cirka 100 000","Över en miljon","Cirka 500 000","Nästan tre miljoner"], correctAnswer:1, chapter:10, chapterName:"Sveriges moderna historia", difficulty:"hard", tags:["historia","utvandring"], explanation:"Över en miljon svenskar utvandrade till USA mellan 1850 och 1920 i hopp om ett bättre liv." },
  { id:78, question:"Vilket år blev Sverige medlem i EU?", options:["1991","1993","1995","2000"], correctAnswer:2, chapter:11, chapterName:"Sverige och omvärlden", difficulty:"easy", tags:["EU","historia"], explanation:"Sverige har varit medlem i EU (Europeiska unionen) sedan 1995." },
  { id:79, question:"Vad kallas de fyra friheterna inom EU?", options:["Yttrandefrihet, rörelsefrihet, religionsfrihet och mötesfrihet","Fri rörlighet för personer, varor, tjänster och kapital","Fri handel, fri invandring, fri utbildning och fri sjukvård","Frihet från krig, hunger, fattigdom och förtryck"], correctAnswer:1, chapter:11, chapterName:"Sverige och omvärlden", difficulty:"medium", tags:["EU","frihet"], explanation:"EU:s fyra friheter innebär fri rörlighet för personer, varor, tjänster och kapital mellan medlemsländerna." },
  { id:80, question:"Vilket år blev Sverige medlem i NATO?", options:["2022","2023","2024","2025"], correctAnswer:2, chapter:11, chapterName:"Sverige och omvärlden", difficulty:"medium", tags:["NATO","försvar","historia"], explanation:"Sverige ansökte om NATO-medlemskap 2022 efter Rysslands invasion av Ukraina och blev formellt medlem 2024." },
  { id:81, question:"Vad är Sidas uppgift?", options:["Att förvalta Sveriges utlandsskulder","Att minska fattigdom och förtryck i världen genom internationellt utvecklingssamarbete","Att rekrytera personal till FN","Att administrera Sveriges EU-bidrag"], correctAnswer:1, chapter:11, chapterName:"Sverige och omvärlden", difficulty:"medium", tags:["internationellt","bistånd"], explanation:"Sida (Styrelsen för internationellt utvecklingssamarbete) arbetar för att minska fattigdom och förtryck i världen." },
  { id:82, question:"Vad innebär totalförsvarsplikt i Sverige?", options:["Att alla medborgare måste göra militärtjänst","Att alla som bor i Sverige mellan 16 och 70 år kan bli tvungna att hjälpa till att försvara landet","Att varje vuxen ska delta i civila beredskapskurser","Att man betalar en extra försvarsskatt"], correctAnswer:1, chapter:11, chapterName:"Sverige och omvärlden", difficulty:"medium", tags:["försvar","lag"], explanation:"Alla som bor i Sverige och är mellan 16 och 70 år kan bli tvungna att hjälpa till att försvara landet – totalförsvarsplikt." },
  { id:83, question:"Vilket krig ledde till att Sverige förlorade Finland?", options:["Napoleonkrigen 1813","Kriget mot Ryssland 1808–1809","Trettioåriga kriget","Dansk-svenska kriget 1700"], correctAnswer:1, chapter:11, chapterName:"Sverige och omvärlden", difficulty:"hard", tags:["historia","krig","Finland"], explanation:"I kriget mot Ryssland 1808–1809 förlorade Sverige Finland, som hade tillhört Sverige i nästan 700 år." },
  { id:84, question:"Vad är Europarådet?", options:["EU:s ministerråd","En europeisk organisation grundad 1949 som arbetar för mänskliga rättigheter och demokrati","NATO:s politiska organ","FN:s europeiska avdelning"], correctAnswer:1, chapter:11, chapterName:"Sverige och omvärlden", difficulty:"hard", tags:["Europa","mänskliga rättigheter"], explanation:"Europarådet grundades 1949 och arbetar för mänskliga rättigheter, demokrati och rättsstatens principer." },
  { id:85, question:"Vad innebär att Sverige är en sekulär stat?", options:["Att religion är förbjuden","Att staten är religiöst neutral och inte tar ställning för eller diskriminerar någon religion","Att kyrkan styr staten","Att bara kristendom är tillåten"], correctAnswer:1, chapter:12, chapterName:"Religion i Sverige", difficulty:"easy", tags:["religion","stat"], explanation:"Sverige är en sekulär stat – religiöst neutral och diskriminerar ingen religion. Alla har rätt att fritt välja sin tro." },
  { id:86, question:"Vilket år skildes staten och Svenska kyrkan åt?", options:["1951","1975","2000","2010"], correctAnswer:2, chapter:12, chapterName:"Religion i Sverige", difficulty:"medium", tags:["religion","historia"], explanation:"År 2000 skildes staten och Svenska kyrkan åt. Svenska kyrkan är nu ett av flera trossamfund." },
  { id:87, question:"När kom religionsfrihetslagen i Sverige?", options:["1860","1921","1951","1975"], correctAnswer:2, chapter:12, chapterName:"Religion i Sverige", difficulty:"hard", tags:["religion","historia","lag"], explanation:"Religionsfrihetslagen kom 1951 och gav människor rätt att fritt välja religion – eller att inte tillhöra någon religion alls." },
  { id:88, question:"Vilken är den näst största religionen i Sverige?", options:["Judendom","Hinduism","Buddhism","Islam"], correctAnswer:3, chapter:12, chapterName:"Religion i Sverige", difficulty:"medium", tags:["religion"], explanation:"Islam är den näst största religionen i Sverige, med en kraftig ökning efter andra världskriget via invandring." },
  { id:89, question:"Ungefär hur många medlemmar har Svenska kyrkan?", options:["En miljon","Tre miljoner","Fem miljoner","Sju miljoner"], correctAnswer:2, chapter:12, chapterName:"Religion i Sverige", difficulty:"medium", tags:["religion","kristendom"], explanation:"Svenska kyrkan har omkring fem miljoner medlemmar och är det största kristna samfundet i Sverige." },
  { id:90, question:"Vilket år fick judar fullständiga medborgerliga rättigheter i Sverige?", options:["1780","1838","1870","1910"], correctAnswer:2, chapter:12, chapterName:"Religion i Sverige", difficulty:"hard", tags:["religion","historia","judendom"], explanation:"Det var först 1870 som judar fick fullständiga medborgerliga rättigheter i Sverige." },
  { id:91, question:"Vad garanterar regeringsformen gällande religion?", options:["Att kristendom är statens officiella religion","Att alla har rätt att utöva sin religion och ingen får diskrimineras på grund av sin tro","Att religiösa symboler är förbjudna i offentliga miljöer","Att religiösa skolor inte får statsbidrag"], correctAnswer:1, chapter:12, chapterName:"Religion i Sverige", difficulty:"medium", tags:["religion","grundlagar"], explanation:"Enligt regeringsformen har alla rätt att utöva sin religion och ingen får diskrimineras på grund av sin tro." },
  { id:92, question:"När firas midsommarafton i Sverige?", options:["Den 21 juni varje år","Den 24 juni varje år","En fredag mellan 19 och 25 juni","Första lördagen i juli"], correctAnswer:2, chapter:13, chapterName:"Traditioner och högtider", difficulty:"medium", tags:["traditioner","högtider"], explanation:"Midsommarafton firas alltid på en fredag mellan 19 juni och 25 juni." },
  { id:93, question:"Vad är Sveriges nationaldag och när firas den?", options:["Den 1 maj – arbetarnas dag","Den 6 juni – dagen då Gustav Vasa valdes till kung 1523","Den 24 december – julafton","Den 30 november – Anders dag"], correctAnswer:1, chapter:13, chapterName:"Traditioner och högtider", difficulty:"easy", tags:["traditioner","nationaldag"], explanation:"Sveriges nationaldag firas den 6 juni – dagen Gustav Vasa valdes till kung 1523, starten för Sveriges självständighet." },
  { id:94, question:"Vilket datum firas Lucia?", options:["Den 1 december","Den 13 december","Den 21 december","Den 24 december"], correctAnswer:1, chapter:13, chapterName:"Traditioner och högtider", difficulty:"easy", tags:["traditioner","lucia"], explanation:"Lucia firas den 13 december och handlar om att sprida ljus när det är som mörkast på året." },
  { id:95, question:"Vad äter man traditionellt på midsommar?", options:["Korv, potatisgratäng och mjölk","Sill, färskpotatis och jordgubbar","Köttbullar, lingon och rödbeta","Kräftor, bröd och aquavit"], correctAnswer:1, chapter:13, chapterName:"Traditioner och högtider", difficulty:"easy", tags:["traditioner","midsommar","mat"], explanation:"Vanlig midsommarmat är sill, färskpotatis och jordgubbar." },
  { id:96, question:"Vad är Valborgsmässoafton och när firas den?", options:["En högtid för att minnas de döda, firas 1 november","En fest för att välkomna våren den 30 april med brasor och vårsånger","En kristen högtid som firas 40 dagar efter påsk","Nyårsafton enligt den gamla svenska kalendern"], correctAnswer:1, chapter:13, chapterName:"Traditioner och högtider", difficulty:"medium", tags:["traditioner","valborg"], explanation:"Valborgsmässoafton den 30 april firas för att välkomna våren med brasor och vårsånger." },
  { id:97, question:"Vilket persiskt/kurdiskt nyår firas i samband med vårdagjämningen?", options:["Id al-fitr och Eid al-Adha","Nouruz och Newroz","Diwali och Holi","Yom Kippur och Rosh Hashanah"], correctAnswer:1, chapter:13, chapterName:"Traditioner och högtider", difficulty:"hard", tags:["traditioner","mångkultur"], explanation:"Nouruz (persiskt) och Newroz (kurdiskt) firas vid vårdagjämningen den 21 mars – traditioner som kommit till Sverige med invandrare." },
  { id:98, question:"Vad är advent?", options:["En svensk tradition för att välkomna sommaren","De fyra söndagarna före juldagen den 25 december","Påskens förberedelseperiod","En helg för att minnas Gustav Vasa"], correctAnswer:1, chapter:13, chapterName:"Traditioner och högtider", difficulty:"easy", tags:["traditioner","jul","advent"], explanation:"Advent är de fyra söndagarna före juldagen den 25 december – en förberedelseperiod inför julen." },
  { id:99, question:"Vad uppmärksammas på första maj i Sverige?", options:["Sveriges nationaldag och självständighet","Arbetarnas dag – med demonstrationer arrangerade av arbetarrörelsen","Vårens ankomst med valborgseldarna","Gustav Vasas val till kung"], correctAnswer:1, chapter:13, chapterName:"Traditioner och högtider", difficulty:"easy", tags:["traditioner","första maj"], explanation:"På första maj firas arbetarnas dag. Arbetarrörelsen arrangerar demonstrationer och håller tal om sociala och politiska frågor." },
  { id:100, question:"Vilket är Sveriges statsskick?", options:["En republik med vald president","En konstitutionell monarki där kungen är statschef utan politisk makt","En parlamentarisk republik","En federal stat med delstatsparlament"], correctAnswer:1, chapter:3, chapterName:"Så här styrs Sverige", difficulty:"easy", tags:["statsskick","monarki"], explanation:"Sverige är en konstitutionell monarki. Kungen är statschef men har ingen politisk makt – han fungerar som en symbol för Sverige." },
];
